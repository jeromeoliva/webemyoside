    ...
    <div class="top-nav">
      ...
      <span class="slogan"><a href="index.php" alt="CdsP" title="Plateforme de développement Webemyos "></a><h5>Plateforme de développement Webemyos</h5></span>
        <ul class="nav navbar-nav navbar-right">
           <li class="dropdown">
             <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"> Tableau de bord <span class="caret"></span></a>
             <ul class="dropdown-menu" role="menu">
               <li><a href="#" id='btnStart'><i class="fa fa-tachometer"></i>Mon tableau de bord</a></li>
               <li class="divider"></li>
               <li><a href="#" id='btnIde'><i class="fa fa-desktop"></i>Mes projets</a></li>
               <li class="divider"></li>
               <li><a href="#" id='btnProfil'><i class="fa fa-user"></i>Mon profil</a></li>
               <li class="divider"></li>
               <li><a href="disconnect.php"><i class="fa fa-power-off"></i>Deconnection</a></li>
             </ul>
           </li>
         </ul>
      </div>
