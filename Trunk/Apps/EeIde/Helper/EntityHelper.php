...
class EntityHelper
{
    ...
    public static function CreateFile($core, $name, $shared, $projet, $fields)
    {
         ...
         //Cartouche
         $content .= $newLigne."/* ";
         $content .= $newLigne."*Description de l'entite";
         $content .= $newLigne."*/";
         
         $content .= $newLigne."class ".$name." extends JHomEntity  ";
         $content .= $newLigne.$openAccolade;
         $content .= $newLigne.$tab."//Constructeur";
         $content .= $newLigne.$tab.'function '.$name.'($core)';
	 ...
	 $content .= $newLigne.$tab.$tab.'$this->Alias = "'.$name.'"; ';
	  ...
	  $content .= $newLigne.$tab.$tab.'$this->Create(); ';
        ...
        // $file = "../Data/Apps/EeIde/".$projet."/Entity/".$name.".php";
          $file = $directory."/".$projet."/Entity/".$name.".php";
           
         JFile::Create($file, $content);
    }
    ...
    {
       echo $file = "../Data/Apps/EeIde/".$projet."/Db/Delete".$name.".sql";
        ...
        JFile::Delete("../Data/Apps/EeIde/".$projet."/Entity/".$name.".php");
    }
    ...
    public static function CreateTable($core, $projet)
    {
        ...
        $request = JFile::GetFileContent("../Apps/".$projet."/Db/install.sql", false);
     ...
     * @param type $projet
     */
    public static function DeleteTable($core, $projet)
    {
        //Recuperation du fichier sql
        $request = JFile::GetFileContent("../Apps/".$projet."/Db/uninstall.sql", false);
