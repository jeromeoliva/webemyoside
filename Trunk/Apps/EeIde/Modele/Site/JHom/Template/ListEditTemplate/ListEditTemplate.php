 ...
 */
 class ListEditTemplate extends JHomTemplate
 {
  ...
  function Init()
  {
    ...
    //$this->Grid->CssClass="grille";
    $this->Grid->CssClass="profil";
    ...
    $this->ImgAdd->CssClass="button orange";
          ...
          case DELETE:
			{
            	...
            	$this->Grid->AddColumn(new AjaxActionColumn("","ListEditTemplate", "DeleteEntity", "Entity=".$this->Entity,"",$this->Core->GetCode("Delete"), 'jb'.$this->Entity, true, "icon-remove"));
			}
          break;
        }
      }
