var MyPassBlock = function(){};

MyPassBlock.AsskNewPassword = function()
{
	var parameters = Array();
		parameters["Class"] = 'MyPassBlock';
...
MyPassBlock.SaveNewPassWord = function(user)
{
	...
	var JAjax = new ajax();
		JAjax.data = "Class=MyPassBlock&Methode=NewPassWord";
		JAjax.data += "&u=" + user;
